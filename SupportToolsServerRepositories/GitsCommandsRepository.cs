...
public sealed class GitsCommandsRepository : AbstractRepository, IGitsCommandsRepository
{
    private readonly SupportToolsServerDbContext _dbContext;

    // ReSharper disable once ConvertToPrimaryConstructor
    public GitsCommandsRepository(SupportToolsServerDbContext dbContext) : base(dbContext)
    {
